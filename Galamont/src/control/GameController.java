...
public class GameController
{
	...
	{
		menuSong = new Media(new File("bin\\assets\\Another Damage,DeathNoise(Careful Very Loud).wav").toURI().toString());
	...
	// Image[] bulletImages = new Image[] { new Image("assets/One.png"), new
...
//					{
	...
	private void shoot()
	{
		projectile = new Projectile(1, 1,"O");
		for (int i = 0; i < map.length; i++)
		{
			for (int c = 0; c < map[i].length; c++)
			{
